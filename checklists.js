/**
 * ====================================================================
 * DEVICE CHECKLISTS DATA
 * ====================================================================
 *
 * INSTRUCTIONS:
 *
 * 1. This file contains an array of checklist objects.
 * 2. Each object in the `CHECKLISTS` array represents one inspection list.
 * 3. To add a new checklist, copy the entire object structure (from { to })
 * and add it as a new element in the array.
 *
 * 4. Make sure to update the following fields for each new checklist:
 * - `key`: A UNIQUE identifier (no spaces or special characters).
 * This is crucial for saving progress.
 * Example: "main_st_fire_dept", "city_hall_2024"
 * - `name`: The main title of the checklist.
 * Example: "Main St. Fire Dept."
 * - `location`: The subtitle or location description.
 * Example: "123 Main Street, Anytown"
 * - `devices`: An array of all the device objects for that checklist.
 * You can get this data from your JSON files.
 *
 * 5. The `devices` array should contain objects with the following properties:
 * - loop
 * - address
 * - model
 * - deviceType
...
const CHECKLISTS = [
  {
    key: "mcfarland_city_building", // Unique key for localStorage
  ...
  // {
  //   key: "another_building_2024",
  //   name: "Another Building Inspection",
  //   location: "456 Oak Avenue, Sometown",
  //   devices: [
  //     { loop: 1, address: 1, model: 'XYZ', deviceType: 'Smoke', serialNumber: '...', messages: '...' },
  //     { loop: 1, address: 2, model: 'ABC', deviceType: 'Heat', serialNumber: '...', messages: '...' },
  //     // ... more devices for this list
  //   ]
  // }
